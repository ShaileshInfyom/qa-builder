...
use App\Http\Controllers\API\Device\BookController;
use App\Http\Controllers\API\Device\CategoryController;
...
Route::get('/active-de-active', [CategoryController::class, 'activeDeActive'])
